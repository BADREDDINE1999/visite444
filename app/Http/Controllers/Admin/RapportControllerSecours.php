...
class RapportController extends Controller
{
    ...
    public function index()
    {
        $client = Client::all();
        $produit = Produit::all();
        return view('admin.rapport.index', compact('client', 'produit'));
    ...
    public function create()
    {
        ...
        return view('admin.rapport.create', compact('client', 'produit', 'produitdmd', 'produitprp'));
    }
    ...
    public function store(Request $request )
    {
        ...
        */
        ...
        return redirect('admin/rapport')->with('message','Rapport Added successfully');             // redirect !!!!!!!!!!!!!!!!!!!!
    }
  ...
  /*  public function store3(Request $request)
    {
        ...
        return redirect('admin/step4/' . $visite_id);                  // why   $visite_id !!!!!!!!!!!!!!!!!!!!!
    }
    */
    public function edit()
    {
        ...
        return view('admin.rapport.index',compact('client'));
    }
    public function update(Request $request)
    {
        ...
        return redirect('admin/rapport')->with('message', 'rapport Updated successfully');
    }
